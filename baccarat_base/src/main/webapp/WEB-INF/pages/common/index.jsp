...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		style="height:50px;padding:10px;background:url('./images/casino-1.jpg') no-repeat;background-size:cover">
	...
	<div data-options="region:'south',border:false"
		style="height:50px;padding:10px;background:url('./images/header_bg.jpg') no-repeat right;">
